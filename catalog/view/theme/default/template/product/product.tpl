    ...
    <div class="container">
        <div class="row">
            <div class="details-product">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-6 col-lg-7 details-pro">
                            ...
                            <div class="price-box" itemscope itemtype="http://schema.org/Offer">
                                ...
                                <span class="old-price"><del class="price product-price-old sale" itemprop="priceSpecification">900.000₫</del>
									<meta itemprop="priceCurrency" content="VND">
								</span>
                            </div>
                            <div class="product-summary product-description">
                                <div class="rte description  rte-summary">
                                    <p><strong>Balo laptop nam nữ cỡ lớn: </strong>Chất liệu vải bố bền, chắc chắn, kéo dài thời gian sử dụng, đem lại yên tâm cho người sử dụng. Thiết kế thời trang, phối màu nổi bật cho phái đẹp và phái mạnh tự tin xuống phố</p>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group form_button_details margin-top-5">
                                        <div class="form_product_content ">
                                            ...
                                            <div class="button_actions clearfix">
                                                ...
                                                <a class="btn btn_base btn_call" href="tel:01659329688">
                ...
                <div class="col-lg-3 col-md-3 col-sm-12 hidden-xs hidden-sm hidden-md"></div>
